                                ...
                                <div class="col-md-5">
                                    <div class="card">
                                            <div class="card-header text-dark"> <b>Hello!</b></div>
                                                    <small class="p-3 text-center     fs-3 text-secondary ">For account activation, kindly wait. <br> After your account has been activated, <br> you will receive an SMS.  Then click this link to login<span class="text-danger"><br> <a href="https://auctionear.shop/login">Login here</a></span></small>
                                                <div class="card-body">
